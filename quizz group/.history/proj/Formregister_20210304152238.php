...
include("header.inc.php");
    ...
    <form method="POST" action="#">
        ...
        <div class="input-group input-group-lg">
            ...
            <input type="text" class="form-control champs" name="email" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
        </div>
        <div class="input-group input-group-lg">
            <div class="input-group-prepend">
                <span class="input-group-text oui" id="inputGroup-sizing-lg">Large</span>
            </div>
            <input type="text" class="form-control champs" name="Username" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
        </div>
        <div class="input-group input-group-lg">
            <div class="input-group-prepend">
                <span class="input-group-text oui" id="inputGroup-sizing-lg">Large</span>
            </div>
            <input type="password" class="form-control champs" name="mdp" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
