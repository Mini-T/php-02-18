<?php try {
        ...
        //Insertion
         ...
         $result = $pdo->exec("INSERT INTO question (question, id_reponse) VALUES ('Question2', 2)");

         echo $result . '<br>'; // renvoi le nombre de valeur qui on été ajoutées

        //Modification

        $result = $pdo->exec("UPDATE question SET question = 'Quelle est ......'");
        ...
        echo $result . '<br>';
        //Affichage
        $result = $pdo->query("SELECT * FROM question WHERE question = 'Question1'");
